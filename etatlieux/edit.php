...
<head>  
  <meta charset="utf-8" />
  <title>Decaissement | Modifier</title>
                ...
                <section class="scrollable padder">              
                  ...
                  <div class="row">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM Decaissement WHERE ID= '$ide' AND HotelID = '$hotelid'"; 
...
<form method="post" action="edit_process.php">
    <p class="h4 text-center mb-4">Modifier Information Decaissement</p>
    <br>
    ...
    <div class="md-form">
        ...
        <input type="number" id="Montant" class="form-control" value="<?php foreach ($result as $roie){ echo $roie['Montant']; } ?>" name="montant" required autofocus>
