                  ...
                  <section class="row m-b-md">
                      <center>
                        <?php
                          ...
                          $sql = "SELECT * FROM Immeuble WHERE agenceID = '$agenceid'"; 
...
<form method="post" action="add_process.php">
    <p class="h4 text-center mb-4">Nouveau Bien</p>
    <br>
    ...
    <div class="md-form ">
        ...
        <select class="form-control chosen-select" id="immeubleid" name="immeubleid" required>
                  <option value=""></option>
    ...
    <div class="md-form">
        ...
        <input type="text" id="nom" class="form-control" name="nom" autofocus>
    ...
    <div class="md-form">
        ...
        <input type="text" id="loyerprix" class="form-control" name="loyerprix" required autofocus>
        <label for="materialFormSubscriptionEmailEx">Loyer</label>
    </div>
    <br>
    ...
    <div class="md-form">
        ...
        <input type="number" id="nombrepiece" class="form-control" name="nombrepiece" required autofocus>
        <label for="materialFormSubscriptionEmailEx">Nombre de Piece</label>
    </div>
    <br>
