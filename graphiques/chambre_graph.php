<?php
   session_start();
    ...
    $sql = "SELECT COUNT(Chambre.Type) AS nombre, Chambre.Type AS type, Enregistrement.ChambreID
    FROM Enregistrement,Chambre 
    WHERE Enregistrement.ChambreID = Chambre.ID 
          ...
          <section class="hbox stretch">
            <section>
              <section class="vbox">
                ...
                <p class="h4 text-center mb-4">GRAPHE DES CHAMBRES LES PLUS DEMANDEES POUR L'ANNEE EN COURS 
