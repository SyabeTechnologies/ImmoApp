...
<head>  
  <meta charset="utf-8" />
  <title>Proprietaire | Ajouter</title>
...
<form method="post" action="add_process.php">
    <p class="h4 text-center mb-4">Nouveau Proprietaire</p>
    <br>
    ...
    <br>
        ...
        <input type="text" id="contrat" class="form-control" name="contrat" required autofocus>
