...
<head>  
  <meta charset="utf-8" />
  <title>Partenaire | Modifier</title>
                ...
                <section class="scrollable padder">              
                  ...
                  <div class="row">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM Partenaire WHERE ID= '$ide' AND AgenceID = '$agenceid'"; 
...
<form method="post" action="edit_process.php">
    <p class="h4 text-center mb-4">Modifier Information Partenaire</p>
    <br>
  ...
  <div class="md-form ">
        ...
        <input type="text" id="specialite" class="form-control" value="<?php foreach ($result as $roie){ echo $roie['Specialite']; } ?>" name="specialite" required autofocus>
    ...
    <br>
     ...
     <div class="md-form ">
        ...
        <input type="text" id="email" class="form-control" value="<?php foreach ($result as $roie){ echo $roie['Email']; } ?>" name="email" required autofocus>
